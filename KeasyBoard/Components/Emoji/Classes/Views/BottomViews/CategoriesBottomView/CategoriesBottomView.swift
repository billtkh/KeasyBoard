...
final internal class CategoriesBottomView: UIView {
    ...
    static internal func loadFromNib(with categories: [Category], needToShowAbcButton: Bool) -> CategoriesBottomView {
        ...
        guard let nib = Bundle.main.loadNibNamed(nibName, owner: nil, options: nil) as? [CategoriesBottomView] else {
            fatalError()
        }
    ...
    override func layoutSubviews() {
        ...
        changeKeyboardButton.setTitleColor(KeasyStyleManager.shared.keyColor, for: .normal)
